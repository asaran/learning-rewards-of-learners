...
class AtariHeadDataset():
    ...
    def __init__(self, env_name, data_path):
        ...
        # print((self.trajectories['seaquest'].keys()))
        # print((self.trajectories['seaquest'][507]))
        ...
        for g in self.trajectories.keys():
            ...
            # TODO: separate episode wise, combine episodes across trials
        ...
        for traj in traj_list:
            ...
            if(traj.endswith('.txt') and curr_trial in valid_trial_nums):
                if curr_trial in loaded_from.keys():
                    ...
                    curr_traj = []
                    last_episode = 0 # TODO: only if starting a new episode, update for loading from previous game
                    ...
                    for i,line in enumerate(f):
                        ...
                        if i > 1:
                            ...
                            if curr_data[2]!='null':    # skipping the frames with a NULL score
                                ...
                                # print(curr_data[6:])
                                curr_trans['gaze_positions']  = ([float(gp) if gp!='null' else float('nan') for gp in curr_data[6:]])
                                ...
                                if(curr_trans['episode']!=last_episode and not math.isnan(curr_trans['episode'])):
                                    ...
                                    print(extra_episode_num, traj, curr_trans['episode'], last_episode)
